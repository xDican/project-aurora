...
export const es = {
  ...
  salonPage: {
    ...
    board: {
      ...
      showingFor: (n: number, date: string) =>
        `Mostrando ${n} ${n === 1 ? "espacio" : "espacios"} para el ${date}`,
      free:       "Libre",
      occupied:   "Ocupado",
      reserve:    "Reservar",
      noSpaces:   "No hay espacios configurados. Un admin debe crearlos primero.",
    ...
    form: {
      guestLabel:         "Cliente",
      eventDataTitle:     "Datos del evento",
      cateringTitle:      "Catering",
      menuTypeLabel:      "Tipo de menú",
      summaryLabel:       "Resumen de costos",
      contextSpace:       "Espacio",
      contextDate:        "Fecha",
      contextSlot:        "Horario",
      spaceLabel:         "Espacio",
      slotLabel:          "Slot",
      horariosTitle:      "Horarios disponibles",
      variosDias:         "Varios días",
      dateLabel:          "Fecha",
      pickSpaceForSlots:  "Selecciona un espacio para ver sus horarios.",
      pickDateForSlots:   "Elegí una fecha para ver la disponibilidad de horarios.",
      ...
      noResourcesWarning: "No hay recursos configurados. Un admin debe agregarlos primero.",
      ...
      basePriceLabel:     "Precio base",
      equipmentPriceLabel: "Equipamiento",
      cateringPriceLabel: "Catering",
      totalLabel:         "Total",
      saveChanges:        "Guardar cambios",
    },
    ...
    errors: {
      ...
      resourceUnavailable: (name: string) => `"${name}" no está disponible para ese horario.`,
    },
